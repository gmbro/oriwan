        ...
        <div className="rounded-[26px] bg-white space-y-7 p-5 text-sm leading-7 text-oriwan-text-muted shadow-sm ring-1 ring-slate-950/5 sm:p-8 sm:text-[15px]">
          ...
          <section>
            ...
            <p>
              ...
              멤버 직접 인증은 업로드 시각과 관계없이 사진에서 거리 3km 이상과 운동 시작 시각 00:00~07:59를 확인한 경우에 완료됩니다. 같은 날 여러 운동을 등록할 수 있으며 거리·시간은 모두 합산하되 인증일과 응원 상자는 하루 한 번만 인정합니다. 같은 사진은 중복 합산하지 않습니다.
