        ...
        <div className="card p-6 space-y-6 text-sm leading-relaxed text-oriwan-text-muted">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>참가자의 Google 로그인 기반 개인 기록 입력 및 조회</li>
          ...
          <section>
            ...
            <p>참가자 화면은 로그인 없이 전체 인증 현황을 볼 수 있는 공개 대시보드입니다. 개별 참가자는 Google 로그인 후 이름을 필수로 등록해야 하며, 해당 이름이 운영자가 등록한 참가자명과 일치할 때 본인 기록 입력과 조회가 가능합니다.</p>
          </section>
