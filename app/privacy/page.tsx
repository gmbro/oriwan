        ...
        <div className="rounded-[26px] bg-white space-y-7 p-5 text-sm leading-7 text-oriwan-text-muted shadow-sm ring-1 ring-slate-950/5 sm:p-8 sm:text-[15px]">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li><strong>100일 목표 설정:</strong> 목표, 선택 입력한 다짐과 생성 시각. 로그인한 본인만 조회·수정 가능</li>
          ...
          <section>
            ...
            <p className="mt-2">
              100일 목표 설정의 목표 본문은 서버 전용 저장소에 보관하며, 로그인한 작성자 본인의 개인 API 응답에만 포함합니다. 관리자 화면과 다른 멤버에게는 공개하지 않습니다. 이용자는 위 이메일로 삭제를 요청할 수 있으며, 4기 운영 기록 정리 시
              함께 삭제합니다.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>목표 본문은 작성자 인증을 확인한 개인 API에서만 반환합니다.</li>
