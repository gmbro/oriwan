        ...
        <div className="rounded-[26px] bg-white space-y-7 p-5 text-sm leading-7 text-oriwan-text-muted shadow-sm ring-1 ring-slate-950/5 sm:p-8 sm:text-[15px]">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li><strong>인증 검수 정보:</strong> 이용자 또는 운영자가 올린 러닝 기록 이미지, OCR 추출문·신뢰도·운동 시작 시각·거리, 이용자가 선택한 인증 날짜와 실제 업로드 시각. 멤버 직접 등록의 3km 이상·오전 8시 이전 시작 조건 확인과 운영자 정정에 사용합니다. 조건 미달 또는 인식 실패 시에도 분석용 사진과 초안은 비공개 저장소에 남을 수 있으며 인증 완료 기록으로 집계하지 않습니다.</li>
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>사진에서 운동 거리 3km 이상·운동 시작 시각 오전 8시 이전을 확인하는 자동 인증 판정, 실패 사유 안내, 운영자의 예외 등록 및 기록 정정</li>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              사용합니다. 기존 가입자에게는 이를 소급 적용하지 않습니다. 이용자는 멤버 목록의 본인 카드를 눌러 프로필에서 사진을 바꾸거나
              삭제할 수 있고, 운영자도 크루프로필에서 수정할 수 있습니다.
            </p>
            <p className="mt-2">
              연결된 개인 이용자는 멤버 목록의 본인 카드를 눌러 프로필에서 자신의 표시 이름·사진을 바꾸고 인증샷을 직접 올려 이미지 식별과 검수를 요청할 수 있습니다.
              직접 등록은 사진에서 거리 3km 이상과 오전 8시 이전 운동 시작 시각을 확인한 후 인증 완료로 반영합니다. 조건 미달 또는 인식 실패 시 안내하며, 운영자는 예외 기록을 등록하거나 정정할 수 있습니다. 다른 멤버 관리와 자기소개 수정은 운영자에게만 제공합니다. 로그인하면
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              정보로 보관합니다. 이용자가 멤버 목록의 본인 카드를 눌러 프로필에서 사진을 삭제하면 서비스가 만든 공개용 사진 사본은 즉시 삭제합니다. 탈퇴 또는 연결 해제를 확인하면 법령상 보존 의무가 있는 경우를 제외하고 운영 중인 Auth·Storage와
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              동의 철회는 다른 기능 이용에 불이익을 주지 않습니다. 이미 복사된 공개 프로필 사진은 멤버 목록의 본인 카드를 눌러 프로필에서 직접
