...
export default function Home(){return <main className="min-h-dvh bg-[#f2f4f6] text-[#191f28]">
 ...
 <section id="participate" className="rounded-3xl bg-white p-6 sm:p-10"><h2 className="text-2xl font-bold">스내사 참여 방법</h2><ol className="mt-5 list-inside list-decimal space-y-4 leading-7 text-slate-600"><li>참가 전 운영자에게 현재 모집 여부와 참여 조건을 확인해주세요.</li><li>참여할 준비가 되면 대시보드에서 카카오로 로그인해주세요. 현재 로그인 시 4기 멤버로 연결되는 방식입니다.</li><li>운동 날짜·시작 시각·거리가 보이는 캡처를 인증 메뉴에 올려주세요.</li><li>운영자가 확인한 기록이 공식 인증에 반영됩니다.</li></ol></section>
