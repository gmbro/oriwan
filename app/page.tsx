...
export default function Home(){return <div className="min-h-dvh bg-[#f2f4f6] text-[#191f28]">
 <section className="mx-auto max-w-4xl px-6 py-5"><h1 className="text-2xl font-black">스내사 · 함께 시작하는 아침</h1><p className="mt-2 text-slate-600">스스로 내던지는 사람들의 100일 러닝 도전. 로그인 없이 멤버의 승인 기록과 공동 여정을 구경하세요.</p><a href="#participate" className="mt-3 inline-block font-bold text-blue-600">참여 방법 알아보기</a></section>
 <FourthDashboardContent />
 <div className="mx-auto max-w-4xl space-y-6 px-6 pb-16">
 <section className="rounded-3xl bg-white p-6 sm:p-10"><h2 className="text-2xl font-bold">스내사 4기 · 100일의 도전</h2><p className="mt-4 leading-8 text-slate-600">2026년 9월 23일부터 12월 31일까지, 하루하루 운동한 기록을 쌓는 도전입니다. 첫 공동 목표는 다 같이 1,000km 달성하기입니다. 운영자가 승인한 러닝 거리가 쌓이면 다음 목표가 열립니다.</p><p className="mt-3 leading-8 text-slate-600">대시보드에서는 공동 인증 현황과 목표를 확인할 수 있어요. 이름·승인 누적 거리·운동 시간·인증 일수·이번 주 기록은 로그인 없이 볼 수 있으며, 인증 원본은 공개 소개 페이지에 표시하지 않습니다.</p></section>
 ...
 <section className="rounded-3xl bg-white p-6 sm:p-10"><h2 className="text-2xl font-bold">자주 묻는 질문</h2><div className="mt-5 space-y-6 leading-7"><div><h3 className="font-bold">스내사는 무슨 뜻인가요?</h3><p className="mt-2 text-slate-600">‘스스로 내던지는 사람들’을 줄인 이름입니다. TWTT 안에서 함께 운동하고 기록하는 도전입니다.</p></div><div><h3 className="font-bold">인증 사진은 언제 올려야 하나요?</h3><p className="mt-2 text-slate-600">오전 8시 이전에 운동을 시작했다는 시각이 보이도록 올려주세요. 업로드한 시간보다 캡처에 표시된 운동 날짜와 시작 시각을 확인하며, 운영자가 최종 승인합니다.</p></div><div><h3 className="font-bold">로그인 없이 구경할 수 있나요?</h3><p className="mt-2 text-slate-600">공개 소개와 대시보드의 공동 현황은 볼 수 있습니다. 상세 인증 기록과 회원 기능은 운영자가 승인한 멤버에게만 제공됩니다.</p></div><div><h3 className="font-bold">교정운동도 문의할 수 있나요?</h3><p className="mt-2 text-slate-600">참여 회원은 내 정보의 교정운동 메뉴에서 운영자에게 문의할 수 있습니다. 제공 방식과 일정은 운영자에게 확인해주세요.</p></div></div></section>
