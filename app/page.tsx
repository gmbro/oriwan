...
export const metadata={
 ...publicPageMetadata("스내사 · 스스로 내던지는 사람들 · TWTT 아침러닝 챌린지 | 창업가를 위한 심신단련 커뮤니티", "스내사, 스스로 내던지는 사람들. TWTT 아침러닝 챌린지는 창업가를 위한 심신단련 커뮤니티입니다. 트레바리 러닝·독서 모임과 100일 습관 챌린지를 만나보세요.", "/"),
