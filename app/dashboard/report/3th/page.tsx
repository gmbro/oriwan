        ...
        <section className="relative overflow-hidden rounded-[26px] bg-[#101522] px-4 py-5 text-white shadow-2xl shadow-slate-950/15 sm:rounded-[30px] sm:px-7 sm:py-8">
          ...
          <div className="relative">
            <div className="flex flex-wrap items-center gap-2">
              <p className="inline-flex rounded-full bg-lime-300 px-3 py-1 text-[10px] font-black text-slate-950">TWTT 3RD · SEASON ARCHIVE</p>
              <span className="rounded-full bg-white/10 px-3 py-1 text-[10px] font-black text-white/70 ring-1 ring-white/10">지난 시즌 기록</span>
            </div>
