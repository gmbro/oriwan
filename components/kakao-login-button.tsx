  ...
  return (
    <div className={compact ? "inline-flex shrink-0" : "w-full"}>
      <a
        ...
        className={`inline-flex items-center justify-center gap-2 bg-[#FEE500] font-black text-[#191919] transition hover:bg-[#f4dc00] focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-[#191919]/30 ${compact
