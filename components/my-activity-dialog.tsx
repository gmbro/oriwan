...
const titles: Record<MyActivitySection, string> = { locker: "보관함", support: "후원", home: "내 정보", profile: "내 정보", upload: "내 정보", records: "내 정보", fortune: "오늘 운세", gift: "인증박스", corrective: "교정운동", "time-machine": "목표 설정" };
